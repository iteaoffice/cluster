...
$config = [
    'controllers'        => [
        'factories' => [
            ...
            Controller\ClusterManagerController::class         => ConfigAbstractFactory::class,
    ...
    'controller_plugins' => [
        'aliases'   => [
            'createCluster'                => Controller\Plugin\CreateCluster::class,
            'getClusterFilter'             => Controller\Plugin\GetFilter::class,
            'rosterGenerator'                 => Controller\Plugin\RosterGenerator::class,
            'clusterReportExcelExport'     => Controller\Plugin\Report\ExcelExport::class,
            'clusterReportExcelDownload'   => Controller\Plugin\Report\ExcelDownload::class,
            'clusterReportPdfExport'       => Controller\Plugin\Report\PdfExport::class,
            'clusterConsolidatedPdfExport' => Controller\Plugin\Report\ConsolidatedPdfExport::class,
            'clusterReportExcelImport'     => Controller\Plugin\Report\ExcelImport::class,
            'clusterReportPresentation'    => Controller\Plugin\Report\Presentation::class,
            'renderProjectCluster'         => Controller\Plugin\RenderProjectCluster::class,
        ],
        'factories' => [
            Controller\Plugin\CreateCluster::class             => ConfigAbstractFactory::class,
            ...
            Controller\Plugin\RenderProjectCluster::class      => ConfigAbstractFactory::class,
        ],
    ],
    'view_manager'       => [
    ...
    'view_helpers'       => [
        'aliases' => [
            ...
            'clusterReportLink'             => View\Helper\ReportLink::class,
            'clusterReportDownloadLink'     => View\Helper\Report\DownloadLink::class,
            'clusterReportPresentationLink' => View\Helper\Report\PresentationLink::class,
            'clusterReportFinalLink'        => View\Helper\Report\FinalLink::class,
            'clusterReportProgress'         => View\Helper\Report\Progress::class,
            'clusterReportScore'            => View\Helper\Report\Score::class,
    ...
    'service_manager'    => [
        'factories' => [
            ...
            // Services
            Service\ClusterReportService::class                     => ConfigAbstractFactory::class,
